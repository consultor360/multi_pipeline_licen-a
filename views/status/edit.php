            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php echo render_input('name', _l('leadstatus_name'), $status['name']); ?>
                            </div>
                            <div class="col-md-6">
                                <?php echo render_color_picker('color', _l('leadstatus_color'), $status['color']); ?>
                            </div>
                            <div class="col-md-6">
                                <?php echo render_select('pipeline_id', $pipelines, array('id', 'name'), 'pipeline', $status['pipeline_id']); ?>
                            </div>
                            <div class="col-md-6">
                                <?php echo render_input('order', _l('order'), $status['order'], 'number'); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
